---
title: "Interactive Browser Terminal for Task Workspaces"
sidebarTitle: "Interactive Terminal"
description: "Open a live browser terminal into any task workspace. Run interactive Codex or Claude sessions, or use the restricted Git terminal for branch and diff operations."
---
...
| Event | Message |
|---|---|
| Session started | `Interactive terminal session started.` or `Git terminal session started.` |
| Session ended | `Interactive terminal session ended.` or `Git terminal session ended.` |
| No changes detected | `Interactive terminal session ended. No workspace changes were detected.` |
| Changes available for review | `Interactive terminal session ended. Review proposed changes below.` |
